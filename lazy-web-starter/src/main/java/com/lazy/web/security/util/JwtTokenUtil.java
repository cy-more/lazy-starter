package com.lazy.web.security.util;
...
public class JwtTokenUtil {
    ...
    public JwtTokenUtil(YsSecurityProperties securityProperties) {
...
//        String token = refreshToken.substring(securityProperties.getJwtTokenHead().length());
    ...
    @Data
    public static class RefreshResult implements Serializable {
