...
import com.lazy.web.security.entity.YsOrganize;
import com.lazy.web.security.entity.YsUser;
import com.lazy.web.security.handler.YsLoginFailHandler;
import com.lazy.web.security.handler.YsLoginSuccessHandler;
...
public class JwtLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        if (ObjectUtil.isNotEmpty(currentOrganize) && ObjectUtil.isNotEmpty(userOrganizes)
                && !userOrganizes.stream().map(YsOrganize::getCode).collect(Collectors.toList()).containsAll(currentOrganize)) {
